  ...
  <div class="sticky top-0 z-100 transition-all duration-500 bg-white">
    ...
    >
      <!-- <div class=" sticky top-0 z-100 transition-all duration-500 bg-white"> -->
      <!-- <div
        class="mx-auto px-4 h-20 md:h-24 flex items-center justify-between"
      > -->
      <a
        href="#"
          ...
          <ul class="flex items-center space-x-1 relative z-10">
            ...
            >
              <div
                ...
                :style="{
                  [movingDirection === 'right' ? 'left' : 'right']:
                    ambulanceOffset + 'px',
                }"
              >
                <div class="relative flex items-center">
                  <div
                    v-if="movingDirection === 'right'"
                    class="absolute -left-10 flex flex-col space-y-1"
                  >
                    <div
                      class="w-6 h-0.5 bg-[#00A3C4]/50 rounded animate-speed-trail"
                    ></div>
                    <div
                      class="w-4 h-0.5 bg-[#00A3C4]/30 rounded animate-speed-trail delay-75"
                    ></div>
                    <div
                      class="w-3 h-0.5 bg-[#00A3C4]/20 rounded animate-speed-trail delay-150"
                    ></div>
                  </div>
                  <div
                    v-else
                    class="absolute -right-10 flex flex-col space-y-1"
                  >
                    <div
                      class="w-6 h-0.5 bg-[#00A3C4]/50 rounded animate-speed-trail"
                    ></div>
                  ...
                  <div
                    ...
                    :class="
                      movingDirection === 'right' ? '-left-6' : '-right-6'
                    "
                  >
                    <div
                      class="w-2 h-2 bg-gray-300/40 rounded-full animate-dust-cloud"
                    ></div>
                    <div
                      class="w-1.5 h-1.5 bg-gray-300/30 rounded-full animate-dust-cloud delay-100"
                    ></div>
                    <div
                      class="w-1 h-1 bg-gray-300/20 rounded-full animate-dust-cloud delay-200"
                    ></div>
                  </div>
                </div>
              </div>
              <a
                :href="item.path"
                @click.prevent="scrollToSection(item.path, index)"
      ...
      >
        <div class="flex flex-col space-y-2">
          ...
          <a
            ...
            :key="item.name"
            @click.prevent="mobileScrollTo(item.path)"
            class="text-xl font-bold p-4 rounded-2xl transition-all cursor-pointer"
            :class="
              activeSection === item.path
                ? 'text-[#00A3C4]'
          ...
          >
            <div class="flex space-x-3">
              <button
                ...
                :class="
                  currentLang === code
                    ? 'bg-white border-[#00A3C4] shadow-sm scale-110'
