  ...
  <section id="doctors" class="py-20 md:py-28 bg-gray-50">
    <div class="container mx-auto px-4">
      ...
      <swiper :modules="[Navigation, Autoplay]" :slides-per-view="1" :space-between="20"
        :navigation="{ prevEl: '.prev-btn', nextEl: '.next-btn' }" :autoplay="{ delay: 4000 }" :breakpoints="{
          '640': { slidesPerView: 2 },
          '1024': { slidesPerView: 4 }
        }" class="pb-10 ">
        <swiper-slide v-for="doctor in doctors" :key="doctor.id">
          <div
            class="bg-white cursor-pointer active:cursor-grabbing rounded-2xl p-6 my-10 shadow-sm border border-gray-100 hover:shadow-xl transition-shadow duration-300 text-center group">
