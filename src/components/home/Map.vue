<template>
  <section class="py-20 md:py-28 bg-gray-50 overflow-hidden" id="contact">
    <div class="mx-auto w-full max-w-[1440px] px-6 md:px-12 lg:px-16 xl:px-20">
      <div class="mb-10">
        <h2
          class="text-3xl md:text-4xl font-black text-[#2d3142] relative inline-block"
        >
          Xəritədə Bax
          <span
            class="absolute -bottom-3 left-0 w-16 h-1.5 bg-[#00A3C4] rounded-full"
          ></span>
        </h2>
      </div>
      <div class="flex flex-nowrap sm:flex-wrap gap-3 mb-10 overflow-x-auto pb-4 sm:pb-0 no-scrollbar">
        <button
          v-for="branch in branches"
          :key="branch.id"
          @click="activeBranch = branch"
          :class="[
            'px-6 py-2.5 rounded-full font-bold transition-all duration-300 border shadow-sm whitespace-nowrap text-sm md:text-base',
      ...
      <div class="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
        <div class="w-full lg:w-3/5">
          <div
            class="relative w-full h-110 lg:h-135 rounded-3xl overflow-hidden shadow-xl border border-gray-100"
          >
            <iframe
              ...
              class="grayscale-[0.1] contrast-[1.05]"
            ></iframe>

            <div
              class="absolute top-5 left-5 bg-white p-4 rounded-xl shadow-lg max-w-[260px] z-10 hidden sm:block"
            >
        ...
        <div
          class="w-full lg:w-2/5 bg-white p-8 lg:p-10 rounded-3xl shadow-sm border border-gray-50"
        >
          <div class="mb-8">
            <p class="text-gray-500 text-lg">sualınız var?</p>
            <h2
              class="text-4xl font-extrabold text-[#2d3142] mt-1 relative inline-block"
            >
              Bizimlə əlaqə saxlayın
              <span
                class="absolute -bottom-2 left-0 w-2/3 h-1 bg-[#00A3C4]"
              ></span>
            </h2>
          </div>
            ...
            <div class="relative">
              <div class="absolute inset-y-0 left-0 flex items-center pl-4">
                <div class="relative flex items-center h-full">
                  ...
                  <div
                    class="absolute right-4 pointer-events-none flex items-center"
                  >
                    <i
...
const branches = [
  {
    ...
    mapUrl:
      "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3039.428490186165!2d49.8619113!3d40.3771909!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40307d079efb51ad%3A0xdfc9725621a00940!2sLeyla%20Medical%20Center!5e0!3m2!1str!2saz!4v1715850000000!5m2!1str!2saz", // Real embed linkinizi bura qoyun
    googleMapsLink: "#",
  },
];
