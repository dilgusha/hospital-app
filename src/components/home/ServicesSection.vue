        ...
        <div class="space-y-24 md:space-y-32">
          <div class="flex flex-col lg:flex-row items-center gap-10 lg:gap-20">
            ...
            <div class="w-full lg:w-1/2">
              ...
              >
                <img
                  src="../../assets/images/plain-ambulance.jpg"
            ...
            <div class="w-full lg:w-1/2 space-y-6">
              <div class="inline-block">
                <h2 class="text-4xl font-extrabold text-[#2d3142] mb-2">
                  Hava Ambulansı
                </h2>
                <div class="h-1 w-20 bg-[#00A3C4] rounded-full"></div>
              </div>
              <p class="text-gray-600 leading-relaxed text-lg">
                Referans Medical Group Türkiyənin Apronjet havacılıq şirkətinin
                Azərbaycandakı rəsmi distributoru olaraq Hava Ambulansı ilə də
                xidmətinizdədir. Müraciət edən pasiyentlərin istənilən xarici
                ölkəyə daşınması və təxliyəsi həyata keçirilir.
              </p>
            </div>
          </div>
          ...
          <div class="flex flex-col lg:flex-row-reverse items-center gap-12">
            ...
            <div class="w-full lg:w-1/2">
              ...
              >
                <img
                  src="../../assets/images/ambulance-2.jpg"
                  class="w-full h-[450px] object-cover transition-transform duration-700 group-hover:scale-105"
                  alt="Ambulans parkı"
                />
                <div
            ...
            <div class="w-full lg:w-1/2 space-y-6">
              <div class="inline-block">
                ...
                <p class="text-xl text-[#00A3C4] font-medium mb-2">
                  (istənilən məkanda müşayiət)
                </p>
                <div class="h-1 w-24 bg-[#00A3C4] rounded-full"></div>
              </div>
              <p class="text-gray-600 leading-relaxed text-lg">
                Referans Ambulans Təcili Tibbi Yardım xidməti olaraq istədiyiniz
                məkanda sizi müşayiət edə bilər. Məkandan və zamandan asılı
                olmayaraq, Referans Ambulans xidməti təcrübəli və dinamik tibbi
                heyətlə 7/24 çağırış etdiyiniz nöqtədədir.
              </p>
            </div>
          </div>
        </div>
